...
def main():
    ...
    test(create_dict(['x', 'y', 'z'], ['cat', 'dog', 'bird']), {
         'x': 'cat', 'y': 'dog', 'z': 'bird'})
    test(create_dict([1, 2, 3], ['one', 'two', 'three']),
         {1: 'one', 2: 'two', 3: 'three'})
    print()

    print('merge_dicts')
    test(merge_dicts({'a': 1, 'b': 2}, {'b': 3, 'c': 4}),
         {'a': 1, 'b': 3, 'c': 4})
    test(merge_dicts({'x': 'cat', 'y': 'dog'}, {'y': 'parrot', 'z': 'fish'}), {
         'x': 'cat', 'y': 'parrot', 'z': 'fish'})
    test(merge_dicts({1: 'one', 2: 'two'}, {3: 'three', 4: 'four'}), {
    ...
    test(update_value({'x': 'cat', 'y': 'dog'}, 'y',
         'parrot'), {'x': 'cat', 'y': 'parrot'})
    test(update_value({1: 'one', 2: 'two'}, 3, 'three'),
         {1: 'one', 2: 'two', 3: 'three'})
    print()
